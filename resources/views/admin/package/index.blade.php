    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <a class="breadcrumb-item" href="{{ route('packages.index') }}">Services</a>
            </nav>
        </div><!-- br-pageheader -->
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">Packages</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-toolbar pull-right">
                            <div class="btn-group">
                                <a href="{{ route('packages.create') }}" id="sample_editable_1_new"
                                   class="btn blue">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center text-center">
                                    <a href="{{ route('packages.show',$item->id) }}"
                                    ...
                                    <form action="{{ route('packages.destroy', $item->id) }}" method="POST" id="deleteForm{{$item->id}}">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
